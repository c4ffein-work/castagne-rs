...
enum MODULE_SLOTS_BASE { CORE, PHYSICS, ATTACKS, GRAPHICS, FLOW, EDITOR, INPUT, AI, CUSTOM_1, CUSTOM_2, CUSTOM_3 }

enum INPUTDEVICE_TYPES { EMPTY, KEYBOARD, CONTROLLER, AI }
...
enum GAMEINPUT_SOCD_TYPE { NEUTRAL, NEGATIVE, POSITIVE }

enum MENUS_ELEMENT_TYPES { ACTION, LIST, CUSTOM }

enum GAMEMODES { MODE_BATTLE, MODE_TRAINING, MODE_EDITOR }

enum PHYSICS_SPACES { WORLD, ABSOLUTE, ENTITY }
